const templates = {
    ...
    editPostPage: (context) => {
        ...
        <div class="createPage">
            <div class="photoCreation">
            <img alt="photo" id = "editPhotoLink" src=${post.photoLink} width="300px">
                <div class="photo_header">
                    <div class="information">
                        <h3>Work Of:</h3>
                        <div id='author_name'>
                    ...
                    <div class="information">
                        <h4>Hashtags</h4>
                        <div>
                            <input id="in_hashtags" placeholder=${post.Tags}>
                        </div>
                    </div>
                    <div class="information">
                        <h4>Information</h4>
                        <div>
                            <textarea id="in_comments"  placeholder=${post.description}></textarea>
                        </div>
                    </div>
                </div>
            </div><button class="endButton" onclick="addPost()">Add photo</button>
    ...
    postBlock: (context) => {
        ...
        //let p = post.Tags.split('#').slice(1).map(elem => "#" + elem);
       // post.Tags = p;
        //console.log(post);
